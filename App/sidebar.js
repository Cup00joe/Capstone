...
import homeIcon from './homeIcon.png'; // Import local image
import customerInputIcon from './customerInputIcon.png'; // Import local image
import customerInfoIcon from './customerInfoIcon.png'; // Import local image
import appointmentIcon from './appointmentIcon.png'; // Import local image
import SettingIcon from './SettingIcon.png'; // Import local image

function Sidebar({ calendars, handleSelectCalendar, session, signOut, setPage, googleSignIn }) {
  // State management
